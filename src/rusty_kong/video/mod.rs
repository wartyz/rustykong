...
lazy_static! {
    static ref SPR_CNTL: [SpriteControlBlock; SPRITE_MAX as usize] =
     SpriteControlBlock::new_control_table();
    static ref BG1_CNTL: [BackgroundControlBlock; (TILE_ROW_COUNT * TILE_COL_COUNT) as usize] =
     BackgroundControlBlock::new_control_table();
}
...
// XXX: structure passed in here should hold WindoCanvas, background buffer, and any other state
